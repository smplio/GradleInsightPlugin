...
abstract class ExecutionTimeMeasurementConfiguration @Inject constructor(objects: ObjectFactory) {
    ...
    val executionTimeReporter: Property<ITaskExecutionTimeReporter> = (objects.property(
        ITaskExecutionTimeReporter::class.java
    ) as Property<ITaskExecutionTimeReporter>).convention(
