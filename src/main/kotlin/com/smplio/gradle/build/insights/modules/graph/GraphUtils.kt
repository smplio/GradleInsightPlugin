...
import com.smplio.gradle.build.insights.BuildProjectDependencyGraphTask
...
internal fun orderGraph(rootNode: Node): HashMap<Int, MutableSet<Node>> {
...
internal fun printGraphViz(rootNode: Node, topology: HashMap<Int, MutableSet<Node>>) {
    val styles = arrayOf(
        "",
        "[style=dashed]",
        "[style=dotted]",
